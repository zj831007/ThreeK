...
class Img extends MY_Controller{
     ...
     * @return string
     */
    private function _checkUploadPath($uid, $type, $ext){
     ...
     * @param $ext
     */
    private function _processImg($data, $uid, $type, $goods_id){
    ...
    public function upload(){
        ...
        $img_path = self::_checkUploadPath($uid, $type, $ext);
        ...
        if ( ! $this->upload->do_upload("img")){
            ...
            //处理图片
            self::_processImg($data,$uid, $type, $ext);
